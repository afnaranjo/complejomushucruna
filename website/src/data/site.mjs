...
export const assetManifest = Object.freeze([
  ...
  { path: '/assets/images/acreditacion-medios-periodista.jpg', kind: 'campaign-image' },
  ...
  { path: '/assets/finados/logo-finados-nuevo.png', kind: 'campaign-logo' },
  ...
  { path: '/assets/finados/kjarkas-finados.webp', kind: 'campaign-image' },
  { path: '/assets/finados/kjarkas-finados-960.webp', kind: 'campaign-image' },
