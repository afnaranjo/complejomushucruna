...
export const assetManifest = Object.freeze([
  ...
  { path: '/assets/finados/shows/ambiente-concierto-800.webp', kind: 'campaign-image' },
  ...
  { path: '/assets/finados/mfs/mfs-plaza.svg', kind: 'campaign-logo' },
  { path: '/assets/finados/mfs/mfs-letras.svg', kind: 'campaign-image' },
  { path: '/assets/finados/mfs/mfs-organizadores.svg', kind: 'campaign-logo' },
  { path: '/assets/finados/mfs/mfs-retrato-640.webp', kind: 'campaign-image' },
  { path: '/assets/finados/mfs/mfs-retrato-1100.webp', kind: 'campaign-image' },
  { path: '/assets/finados/mfs/mfs-fondo-800.webp', kind: 'campaign-image' },
  { path: '/assets/finados/mfs/mfs-fondo-1600.webp', kind: 'campaign-image' },
  { path: '/assets/finados/mfs/mfs-arte-oficial-800.webp', kind: 'campaign-image' },
  { path: '/assets/finados/mfs/mfs-arte-oficial-1400.webp', kind: 'campaign-image' },
  { path: '/assets/finados/mfs/fonts/badeen-display-latin.woff2', kind: 'campaign-font' },
