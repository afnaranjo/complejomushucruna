...
export const mediaLegalDocuments = Object.freeze({
  practices: {
    ...
    body: `
      ...
      <section><h2>2. Registro y acreditación</h2><p>Cada medio registra una cuenta, sus datos, su ubicación, sus canales y una persona responsable, con su fotografía de perfil obligatoria. Sin esa fotografía el registro no puede aprobarse. La acreditación está sujeta a revisión y aprobación de la organización. Las condiciones de ingreso, las zonas y los horarios de cobertura serán los que la organización comunique por sus canales oficiales; el registro por sí solo no garantiza acceso a áreas restringidas.</p></section>
  ...
  privacy: {
    ...
    body: `
      ...
      <section><h2>6. Base de datos y seguridad</h2><p>Los datos se registran en una base digital para su recepción, validación, consulta, organización, comunicación, respaldo, actualización y eliminación. El nombre, el teléfono y el correo de la persona de contacto se almacenan cifrados. La fotografía debe ser de la persona responsable del medio —no un logotipo—, es obligatoria para verificar su identidad y gestionar la acreditación, se normaliza y se guarda cifrada con acceso restringido al propio medio y al equipo administrativo autorizado; subirla no autoriza por sí sola su publicación, que depende de la autorización separada de uso de imagen. No se adoptan decisiones con efectos jurídicos basadas únicamente en procesos automatizados.</p></section>
