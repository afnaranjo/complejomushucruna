const steps = Object.freeze([
  ...
  { number: '02', title: 'Completa el registro', text: 'Marca el tipo de medio (radio, televisión, prensa, digital o redes), su ubicación, sus canales y la persona responsable con su foto, que es obligatoria. Si es radio, agrega sus emisoras, oyentes y género.' },
