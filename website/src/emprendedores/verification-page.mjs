...
import { apiBasesForCsp, PRIMARY_API_BASE } from '../finados/runtime-origins.mjs';
 ...
 * returns only the projection needed to confirm an entrepreneur's current standing.
 */
export function renderEmprendedorVerificationPage(page) {
...
<head>
  ...
  <title>Validación de gafete de emprendedor | Finados Mushuc Runa 2026</title>
  <meta name="description" content="Confirma el nivel y el semáforo de un emprendedor participante del programa De emprendedor a influencer de Finados Mushuc Runa 2026.">
  ...
  <meta name="emprendedor-verify-api-base" content="${esc(api)}">
  ...
  <script type="module" src="/assets/finados/emprendedor-verification.js?v=20260922-emprendedores-1"></script>
</head>
<body class="vocero-portal vocero-verification-page" data-emprendedor-verification>
  ...
  <header class="vocero-header">
    ...
    <a href="/finados/emprendedores/">← De emprendedor a influencer</a>
  </header>
  <main id="contenido" class="vocero-workspace vocero-verification-workspace">
    <div class="vocero-access-intro">
      <p class="vocero-eyebrow">De emprendedor a influencer · Finados 2026</p>
      <h1>Validación de gafete</h1>
      <p>Comprueba que este gafete pertenece a un emprendedor participante y consulta su nivel actual.</p>
    </div>
    ...
    <section class="vocero-verification-card" data-vocero-verify-result hidden aria-labelledby="vocero-verify-title">
      ...
      <h2 id="vocero-verify-title">Emprendedor participante</h2>
      <p class="vocero-verification-card__name" data-vocero-verify-name></p>
      <p class="vocero-verification-card__note" data-emprendedor-verify-business></p>
      ...
      <p class="vocero-verification-card__note">Esta información refleja el estado publicado por la coordinación del programa. El gafete es personal y no transferible.</p>
      <a class="vocero-primary" href="/finados/emprendedores/">Conoce el programa</a>
    </section>
    <section class="vocero-verification-card vocero-verification-card--error" data-vocero-verify-error hidden aria-labelledby="vocero-verify-error-title">
      ...
      <a class="vocero-primary" href="/finados/emprendedores/">Volver a Emprendedores</a>
    </section>
  </main>
  <footer class="vocero-footer"><span>Finados Mushuc Runa · Validación individual</span><a href="/finados/emprendedores/politica-de-privacidad/">Privacidad</a></footer>
