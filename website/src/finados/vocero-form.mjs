...
<section class="vocero-badge-panel" data-vocero-badge hidden aria-labelledby="badge-title"><div><p class="vocero-eyebrow">Comparte tu logro</p><h2 id="badge-title">Tu gafete digital</h2><p>Al completar tu registro, genera una imagen lista para compartir como invitado especial de Finados Mushuc Runa 2026.</p><p class="vocero-badge-format">Formato historia 1080 × 1920 · listo para estados y redes sociales.</p><p class="vocero-badge-status" data-vocero-badge-status></p><div class="vocero-badge-actions"><button class="vocero-primary" type="button" data-vocero-badge-download>Descargar gafete</button><button class="vocero-quiet" type="button" data-vocero-badge-share>Compartir</button></div></div><div class="vocero-badge-preview"><img data-vocero-badge-preview alt="Gafete digital de invitado especial Finados Mushuc Runa 2026, formato historia 1080 por 1920"></div></section>
<section class="vocero-videos-panel" data-vocero-videos aria-labelledby="videos-title"><div class="vocero-section-heading"><div><p class="vocero-eyebrow">Contenido de la comunidad</p><h2 id="videos-title">Tus cinco videos</h2><p>La coordinación habilita cada espacio. Cuando se desbloquee uno, pega aquí el enlace público del video.</p></div><span class="vocero-video-counter"><span data-vocero-videos-count>0</span>/5 habilitados</span></div><div class="vocero-video-grid">${videoSlots}</div></section>`;
}
