...
- Publicación externa: solo GitHub. **No está desplegado**: requiere autorización de Alex para desplegar backend y luego frontend, con la migración 033. No se modificaron datos, DNS, Google Sheets, Meta ni otros proyectos.
