...
- [[01_linea-visual/2026-08-28_indice_linea-visual-finados-2026_multicanal_v01|Paquete de línea visual Finados 2026 · en revisión]]

El paquete visual recibido desde Notion está versionado por autorización expresa de Dirección. El eslogan `¡LEGADO QUE NOS UNE!` ya está confirmado y `ES TRADICIÓN` conserva su función narrativa; el paquete sigue `en-revision` por paleta, tipografías, archivos maestros, derechos de imagen y gates editoriales.
